...
def train_model(settings, hyp_params, train_loader, valid_loader, test_loader):
    ...
    for epoch in range(1, hyp_params.num_epochs+1):
        start = time.time()
        train(model, optimizer, criterion, ctc_a2l_module, ctc_v2l_module, ctc_a2l_optimizer, ctc_v2l_optimizer, ctc_criterion, epoch)
        val_loss, results, truths = evaluate(model, ctc_a2l_module, ctc_v2l_module, criterion, test=False)
